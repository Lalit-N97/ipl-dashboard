...
public class BatchConfig {
    ...
    public JdbcBatchItemWriter<MatchEntity> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<MatchEntity>()
                ...
                .sql("INSERT INTO match_entity (id, city, date, player_of_match, venue, team1, team2, toss_winner, toss_decision, match_winner, result, result_margin, umpire1, umpire2) "
    ...
    public Step step1(JdbcBatchItemWriter<MatchEntity> writer) {
        return stepBuilderFactory
            .get("step1")
            .<MatchInputBean, MatchEntity>chunk(10)
            .reader(reader())
            .processor(processor())
            .writer(writer)
            .build();
